...
export const SCENE_3D_REGISTRY = Object.freeze({
  industrial_dryer: scene({
    ...
    asset_license: '3D Warehouse General Model License · Combined Work', asset_author: 'Alibre Design', asset_version: 2,
    ...
    semantic_nodes: [
      { id: 'dryer_drum', mesh_name: 'dryer_drum', label: '回转干燥筒', module: '干燥主机', fields: ['drum_speed', 'product_temperature'], dynamics: { rotate: 'drum_speed', heat: 'product_temperature' } },
      { id: 'feed_hopper', mesh_name: 'feed_hopper', label: '湿料进料系统', module: '进料段', fields: ['wet_feed_rate'], dynamics: { activity: 'wet_feed_rate' } },
      { id: 'air_heater', mesh_name: 'air_heater', label: '热风加热系统', module: '热风系统', fields: ['hot_air_temperature', 'inlet_air_temperature', 'outlet_air_temperature'], dynamics: { heat: 'hot_air_temperature' } },
      { id: 'supply_fan', mesh_name: 'supply_fan', label: '热风风机', module: '热风系统', fields: ['drying_air_flow'], dynamics: { rotate: 'drying_air_flow' } },
      { id: 'exhaust_outlet', mesh_name: 'exhaust_outlet', label: '尾气排出系统', module: '尾气系统', fields: ['exhaust_temperature', 'exhaust_humidity'], dynamics: { heat: 'exhaust_temperature' } },
      { id: 'product_outlet', mesh_name: 'product_outlet', label: '产品出料系统', module: '出料段', fields: ['product_moisture', 'product_temperature'], dynamics: { state: 'product_moisture' } },
      { id: 'process_piping', mesh_name: 'process_piping', label: '工艺连接管线', module: '连接系统', fields: ['drying_air_flow', 'exhaust_temperature'], dynamics: { flow: 'drying_air_flow' } },
      { id: 'maintenance_platform', mesh_name: 'maintenance_platform', label: '维护平台与支撑', module: '设备结构', fields: [] },
    ],
