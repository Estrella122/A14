...
SUPPORTED_SCENARIOS = (
    ...
    "cement_rotary_kiln", "distillation_column", "debutanizer_column",
)
...
SKILLS = [
    ...
    _s("equipment_entity_resolver", "设备实体解析", "orchestration", "识别锅炉、曝气池、回转窑、加热炉、蒸馏塔和脱丁烷塔及编号。", ["号塔", "号炉", "号池", "号窑", "锅炉", "曝气池", "回转窑", "加热炉", "精馏塔", "蒸馏塔", "脱丁烷塔", "反应器"], ["industrial_intent_parser"], "entity"),
    ...
    _s("dataset_scenario_profiler", "数据场景画像", "data", "根据字段组合、单位、范围与采样特征识别钢铁、火电、污水、水泥和炼油场景。", ["场景", "画像", "加热炉", "锅炉", "燃煤", "曝气池", "污水", "回转窑", "水泥", "精馏塔", "蒸馏塔", "脱丁烷塔"], ["csv_asset_manager"], "standardization"),
