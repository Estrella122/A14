...
SKILLS = [
    ...
    _s("equipment_entity_resolver", "设备实体解析", "orchestration", "识别钢铁高炉、炼油脱丁烷精馏塔和工业干燥器及设备编号。", ["号塔", "号炉", "号干燥器", "高炉", "铁水", "精馏塔", "脱丁烷塔", "干燥器", "干燥机", "烘干机"], ["industrial_intent_parser"], "entity"),
    ...
    _s("dataset_scenario_profiler", "数据场景画像", "data", "根据字段组合、单位、范围与采样特征识别钢铁高炉、炼油脱丁烷精馏和工业干燥场景。", ["场景", "画像", "高炉", "铁水", "精馏塔", "脱丁烷塔", "干燥器", "干燥机", "烘干机"], ["csv_asset_manager"], "standardization"),
