...
SKILL_CONTRACTS = {
    row.skill_id: row for row in (
        ...
        _c("missing_anomaly_cleaner", "compute", "missing_anomaly_cleaner", "clean_missing_and_anomalies", "compute", requires=(ArtifactType.STANDARDIZED_DATA, ArtifactType.FIELD_DICTIONARY), produces=(ArtifactType.CLEANED_TRAIN, ArtifactType.CLEANED_VALIDATION, ArtifactType.CLEANED_TEST, ArtifactType.FROZEN_SPLIT, ArtifactType.MODELING_DATASET), gates=("no_future_fill", "target_missing_preserved")),
        ...
        _c("high_snr_dynamic_segment_extractor", "compute", "high_snr_dynamic_segment_extractor", "extract_high_snr_segments", "compute", requires=(ArtifactType.CLEANED_TRAIN, ArtifactType.FROZEN_SPLIT, ArtifactType.FIELD_DICTIONARY), produces=(ArtifactType.SEGMENTATION_REPORT, ArtifactType.SELECTED_SEGMENTS, ArtifactType.SEGMENT_SCORES, ArtifactType.SNR_ESTIMATES, ArtifactType.MODELING_DATASET), gates=("training_partition_only", "minimum_valid_samples")),
        ...
        _c("time_delay_estimator_compensator", "compute", "time_delay_estimator_compensator", "estimate_and_compensate_delay", "compute", requires=(ArtifactType.MODELING_DATASET, ArtifactType.FIELD_DICTIONARY), produces=(ArtifactType.TIME_DELAY_ESTIMATES, ArtifactType.DELAY_COMPENSATED_DATA), gates=("causal_delay", "maximum_lag_bound")),
        ...
        _c("system_identification_trainer", "compute", "system_identification_trainer", "train_system_identification_model", "compute", requires=(ArtifactType.MODELING_DATASET, ArtifactType.CLEANED_VALIDATION, ArtifactType.CLEANED_TEST, ArtifactType.FROZEN_SPLIT, ArtifactType.FIELD_DICTIONARY), produces=(ArtifactType.MODEL_ARTIFACT, ArtifactType.MODEL_METRICS), gates=("external_inputs_declared", "reproducible_fit")),
        ...
        _c("model_diagnostics_evaluator", "compute", "model_diagnostics_evaluator", "evaluate_model_diagnostics", "compute", requires=(ArtifactType.MODEL_ARTIFACT, ArtifactType.MODEL_METRICS), produces=(ArtifactType.MODEL_DIAGNOSTICS,), gates=("single_final_test", "residual_diagnostics")),
        _c("closed_loop_preprocessing_optimizer", "compute", "closed_loop_preprocessing_optimizer", "optimize_preprocessing_closed_loop", "compute", requires=(ArtifactType.MODEL_ARTIFACT, ArtifactType.CLEANED_TRAIN, ArtifactType.CLEANED_VALIDATION, ArtifactType.CLEANED_TEST, ArtifactType.FROZEN_SPLIT, ArtifactType.SELECTED_SEGMENTS, ArtifactType.FIELD_DICTIONARY), produces=(ArtifactType.OPTIMIZATION_REPORT, ArtifactType.OPTIMIZATION_WINNER), gates=("real_data_only", "test_not_in_objective")),
